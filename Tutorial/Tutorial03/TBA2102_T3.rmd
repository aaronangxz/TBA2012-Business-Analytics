...
JobFreq <- BD%>%count(`Credit Risk`)
kable(cFreq, caption = "Frequency of Bank customers by Credit Risk")
slice.cr <- crFreq$n
...
SuppFq <- PO %>%
  count(Supplier)
jable(SuppFq,caption = "Frequency Distribution for supplier")
...
t3 <- table(cost.Group)
kable(t3,caption = "Frequency distribution")
